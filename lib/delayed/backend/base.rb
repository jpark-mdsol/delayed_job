  ...
  module Backend
    module Base
      ...
      def payload_object
        ...
        Rails.logger.info("> delayed_job-4.1.8/../base.rb:73:: #handler: [#{handler}] <")
        begin
          @payload_object ||= YAML.load_dj(handler)
        rescue => e
          Rails.logger.info("> delayed_job-4.1.8/../base.rb:77:: YAML.load_dj exception: [#{e.message}] <")
        end
        Rails.logger.info("> delayed_job-4.1.8/../base.rb:79:: @payload_object loaded successfully <")
